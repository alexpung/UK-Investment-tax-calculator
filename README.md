...
## To use:
File sample is [here](https://github.com/alexpung/UK-Investment-tax-calculator/blob/master/TaxExamples/Interactive%20Brokers/Stocks/InteractiveBrokersStockTradesExample.xml "here"), you can download it and put it in the web app to see how it works.
