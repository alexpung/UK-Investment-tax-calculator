...
public class UkSection104Test
{
    ...
    public void TestAddandRemoveSection104(decimal buyQuantity, decimal buyValue, decimal sellQuantity, decimal sellValue)
    {
        ...
        buyTradeTaxCalculation.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
        ...
        sellTradeTaxCalculation.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
    ...
    public void TestSection104History()
    {
        ...
        UkSection104 ukSection104 = new("IBM");
        tradeTaxCalculation1.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
        tradeTaxCalculation2.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
        tradeTaxCalculation3.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
        tradeTaxCalculation4.MatchWithSection104(ukSection104, TaxableStatus.TAXABLE);
