...
public class UkSection104Test
{
    ...
    {
        Mock<ITradeTaxCalculation> mockTrade1 = MockTrade.CreateMockTrade(100, 1000m, TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade2 = MockTrade.CreateMockTrade(200, 2000m, TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade3 = MockTrade.CreateMockTrade(300, 3000m, TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade4 = MockTrade.CreateMockTrade(400, 8000m, TradeType.SELL);
        UkSection104 ukSection104 = new("IBM");
    ...
    {
        Mock<ITradeTaxCalculation> mockTrade1 = MockTrade.CreateMockTrade(100, 1000m, TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade2 = MockTrade.CreateMockTrade(120, 1500m, TradeType.SELL);
