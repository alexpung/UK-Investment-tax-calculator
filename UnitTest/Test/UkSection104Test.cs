...
public class UkSection104Test
{
    ...
    {
        Mock<ITradeTaxCalculation> mockBuyTrade = MockTrade.CreateMockTrade(buyQuantity, buyValue.ConvertToBaseCurrency(), TradeType.BUY);
        ...
        Mock<ITradeTaxCalculation> mockSellTrade = MockTrade.CreateMockTrade(sellQuantity, sellValue.ConvertToBaseCurrency(), TradeType.SELL);
    ...
    {
        Mock<ITradeTaxCalculation> mockTrade1 = MockTrade.CreateMockTrade(100, 1000m.ConvertToBaseCurrency(), TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade2 = MockTrade.CreateMockTrade(200, 2000m.ConvertToBaseCurrency(), TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade3 = MockTrade.CreateMockTrade(300, 3000m.ConvertToBaseCurrency(), TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade4 = MockTrade.CreateMockTrade(400, 8000m.ConvertToBaseCurrency(), TradeType.SELL);
        UkSection104 ukSection104 = new("IBM");
    ...
    {
        Mock<ITradeTaxCalculation> mockTrade1 = MockTrade.CreateMockTrade(100, 1000m.ConvertToBaseCurrency(), TradeType.BUY);
        Mock<ITradeTaxCalculation> mockTrade2 = MockTrade.CreateMockTrade(120, 1500m.ConvertToBaseCurrency(), TradeType.SELL);
