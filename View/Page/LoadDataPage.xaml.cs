...
{
    public LoadDataPage(LoadAndStartPanel loadAndStartPanel, LoadedFilesStatisticsPanel loadedFilesStatisticsPanel, CalculationSummaryPanel calculationSummaryPanel)
    {
        InitializeComponent();
